...
type HassLightTheme struct{}

func (HassLightTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	...
	case theme.ColorNameHover:
		return color.NRGBA{R: 0xe4, G: 0xf6, B: 0xff, A: 0xff}
	case theme.ColorNameInputBackground:
		return color.NRGBA{R: 0x0, G: 0x0, B: 0x0, A: 0x10}
	case theme.ColorNamePlaceHolder:
		return color.NRGBA{R: 0x88, G: 0x88, B: 0x88, A: 0xff}
	case theme.ColorNamePressed:
		return color.NRGBA{R: 0x0, G: 0x0, B: 0x0, A: 0x19}
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0x3, G: 0xa9, B: 0xf4, A: 0xff}
...
func (HassLightTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (HassLightTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (HassLightTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
